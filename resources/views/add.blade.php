...
@section('foto')
    <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2"
            src="{{ asset('tmplt') }}/assets/img/profile.jpg" alt="" /></span>
@endsection
...
@section('konten')
    <form action="/insert" method="post" enctype="multipart/form-data">
        ...
        <div class="mt-3 ml-5 mr-5">
            ...
            <input type="text" value="{{ old('tag_line') }}" name="tag_line"
        ...
        <div class="mt-1 ml-4 px-4 col-4">
            <span class="d-none d-lg-block"><img id="previewImage"
                    class="two img-profile rounded-circle mx-auto mb-2 invisible" src="" width="100px"
                    height="100px" /></span>
            <label for="formFile" class="form-label">Foto </label>
            <input id="new_file" type="file" name="foto" value="{{ old('foto') }}"
